...
func main() {
	...
	s2 := Datastructures.StackList[int]{}
	s2.Push(4)
	s.Push(10)
	s.Push(20)
	fmt.Println(s.Pop())
	fmt.Println(Datastructures.GetStats(&s))
	fmt.Println(s.Pop())
	fmt.Println(Datastructures.GetStats(&s))
	fmt.Println(Datastructures.GetStatsStack(s))
	//fmt.Println(Datastructures.GetStatsStack(s2))
}
